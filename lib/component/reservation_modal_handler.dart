                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Text(
                            workoutName,
                            style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: grayscaleSwatch[100]),
                          ),
                          const SizedBox(height: 1),
                          Text(
                            '${startTime.month}월 ${startTime.day}일 (${['월', '화', '수', '목', '금', '토', '일'][startTime.weekday - 1]})',
                            style: TextStyle(fontSize: 16, color: grayscaleSwatch[200], fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                      TextButton(
                  ...
                  Center( // 가운데 정렬
                    child: Column(
                      children: [
                        ...
                        Text.rich(
                          TextSpan(
                            style: TextStyle(fontSize: 15, color: grayscaleSwatch[100]), // 기본 스타일
                            children: [
                              TextSpan(
                                text: '일주일 체험', // 볼드 텍스트
                                style: TextStyle(fontWeight: FontWeight.bold, color: primarySwatch[500]),
                              ),
                              const TextSpan(text: '해보시고 결정하실 수 있습니다.'), // 일반 텍스트
                            ],
                          ),
                        ),
                        Text.rich(
